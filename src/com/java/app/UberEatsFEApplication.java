...
import com.java.config.CashConfig;
...
public class UberEatsFEApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(dominos.getFilteredFoodItems(List.of(new com.java.strategy.payment.CuisineBasedFilter(CuisineType.ITALIAN))));
